package oppgave2.klient;

import  oppgave2.dobbelkjedetordnetlistem.DobbelKjedetOrdnetListeM;
...
public class KlientDobbelKjedetOrdnetListeM {
	...
	public static void main(String[] args) {
		...
		DobbelKjedetOrdnetListeM<String> liste = new DobbelKjedetOrdnetListeM(new String("ccc"), new String("zzz"));
